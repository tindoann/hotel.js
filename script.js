(function() {
  ...
  // PART ONE: CREATE HOTEL OBJECT AND WRITE OUT THE OFFER DETAILS - CONTROL COMPONENT 
  ...
  // Write out the hotel name, standard rate, and the special rate - DISPLAY COMPONENT 
